...
TRANSPORT = ["TOTAL", "SNCF-VOYAGEURS", "ESSO BOBIGNY", "ESSOBOBIGNYPVC", "SANEF", "STATION BP NOISY", "RATP", "BOLT", "GARE DU NORD","BP AMIENS LONGPR","ESSO MARCOUSSIS",
                          "AVIA STATION SER","ESSO VILLEMOMBLE"]
...
SALARIES = [
    ...
    "SABOUR OUALID", "HASSANI NADJIM", "SEBA MADJID", "Fedir Nademianov ", "IBAIEK Rim", 
    "Rui CHEN", "GERSON GONCALVES", "ZAID el Houssine", "IBAIEK Rim", "Mr CHAOUI Sabir",
    "Mr Belhaouas Karim", "M HELDER FERNANDO AFONSO VEIGA", "MORENO DIAS CAROLINO 2", "Nouha Bouzaiene"
]
